...
<script type="text/html" id="tmpl-builder_visual_module_item">
	...
	<?php _e('Paste', 'themify') ?>
					...
					<li><a href="#" data-title="<?php _e('Edit', 'themify') ?>" rel="themify-tooltip-bottom"
						   class="themify_module_options" data-module-name="<?php echo !empty($mod_name)?esc_attr($mod_name):''; ?>">
	<?php _e('Edit', 'themify') ?>
						</a></li>
					<li><a href="#" data-title="<?php _e('Styling', 'themify') ?>" rel="themify-tooltip-bottom"
						   class="themify_builder_module_styling js--themify_builder_module_styling ti-brush" data-module-name="<?php echo !empty($mod_name)?esc_attr($mod_name):''; ?>">
