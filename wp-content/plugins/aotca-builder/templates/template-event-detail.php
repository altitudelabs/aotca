...
wp_enqueue_style('event-detail', plugin_dir_url( __FILE__ ) . '/assets/event-detail.css');

$event_itinerary_default = array(
  'start_date' => '',
  'end_date' => '',
  'timezone' => '',
  'location' => '',
...
$fields_args = wp_parse_args( $mod_settings, $event_itinerary_default );
...
<div id="<?php echo $module_ID; ?>" class="<?php echo esc_attr( $container_class ); ?>">
  <div class="event-detail-container aotca-viewport">
    <section class="event-itinerary">
      <div class="date-time">
        <h3 class="title">
          Date and Time
        </h3>
